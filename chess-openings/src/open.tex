...
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
\fenboard{r1bq1b1r/ppp2kpp/2n5/3np3/2B5/8/PPPP1PPP/RNBQK2R w KQ - 0 7}
\raggedright
\begin{center}
\scalebox{.560}{\showboard}
\end{center}
...
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
\fenboard{rnbqkb1r/ppp2ppp/3p1n2/8/3NP3/2N5/PPP2PPP/R1BQKB1R b KQkq - 2 5}
\raggedright
\begin{center}
\scalebox{.560}{\showboard}
\end{center}
...
Philidor's \variation{3...f5} is dubious.\vspace{2mm}
\end{minipage}
\newline
\begin{minipage}[t]{.175\linewidth}
